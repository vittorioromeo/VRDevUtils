...
FOLDERS=("SSVEntitySystem" "SSVLuaWrapper" "SSVUtils" "SSVUtilsJson" "SSVJsonCpp" "SSVSCollision" "SSVNewRogue" "SSVMenuSystem" "SSVStart" "SSVRPGSystem") # Consider gathering these with a loop?
